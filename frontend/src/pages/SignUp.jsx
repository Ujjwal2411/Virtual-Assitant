    ...
    return (
        ...
        style={{backgroundImage:`url(${bg})`}}>
            ...
            gap-[20px] px-[20px]" onSubmit={handleSignUp}>
                ...
                mb-[30px]">Register to <span className="text-blue-400">Assitant</span></h1>
               ...
               {!showPassword && <IoMdEye className="absolute top-[285px] right-[35px] w-[25px]
                h-[25px] text-[white] cursor-pointer" onClick={()=>setShowPassword(true)}/>}
                {showPassword && <IoMdEyeOff className="absolute top-[285px] right-[35px] w-[25px]
